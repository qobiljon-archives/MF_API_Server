    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stress_type', models.CharField(max_length=32)),
                ('stress_cause', models.CharField(max_length=128)),
                ('repeat_mode', models.SmallIntegerField()),
                ('repeat_id', models.BigIntegerField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='MainModule.Event')),
            ],
        ),
        migrations.CreateModel(
            name='Survey',
